...
9t Android 0.6.1 is a native Android receiver with the **full existing web workspace embedded inside the app**. It is not a rewrite of every web feature into native widgets.
...
1. Install 0.6.1 over the existing app; do not uninstall. Confirm **9t 0.6.1** in Connect.
