...
declare namespace __next_route_internal_types__ {
  ...
  type StaticRoutes = 
    ...
    | `/api/auth/token` // ../../src/app/api/auth/token/route.ts
    ...
    | `/api/mobile` // ../../src/app/api/mobile/route.ts
    | `/api/objects` // ../../src/app/api/objects/route.ts
    | `/api/setup` // ../../src/app/api/setup/route.ts
    | `/api/share-target` // ../../src/app/api/share-target/route.ts
    | `/api/shares` // ../../src/app/api/shares/route.ts
    | `/api/status` // ../../src/app/api/status/route.ts
    | `/devices` // ../../src/app/devices/page.tsx
  type DynamicRoutes<T extends string = string> = 
    | `/api/files/${SafeSlug<T>}` // ../../src/app/api/files/[id]/route.ts
    | `/api/objects/${SafeSlug<T>}` // ../../src/app/api/objects/[id]/route.ts
    | `/api/public/${SafeSlug<T>}/file` // ../../src/app/api/public/[token]/file/route.ts
    | `/api/public/${SafeSlug<T>}/unlock` // ../../src/app/api/public/[token]/unlock/route.ts
    | `/api/shares/${SafeSlug<T>}` // ../../src/app/api/shares/[id]/route.ts
    | `/o/${SafeSlug<T>}` // ../../src/app/o/[id]/page.tsx
    | `/s/${SafeSlug<T>}` // ../../src/app/s/[token]/page.tsx
