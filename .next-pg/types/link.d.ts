...
declare namespace __next_route_internal_types__ {
  ...
  type StaticRoutes = 
    ...
    | `/api/auth/token` // ../../app/api/auth/token/route.ts
    | `/api/config` // ../../app/api/config/route.ts
    | `/api/devices` // ../../app/api/devices/route.ts
    | `/api/diagnostics` // ../../app/api/diagnostics/route.ts
    | `/api/mobile` // ../../app/api/mobile/route.ts
    | `/api/objects` // ../../app/api/objects/route.ts
    | `/api/setup` // ../../app/api/setup/route.ts
    | `/api/share-target` // ../../app/api/share-target/route.ts
    | `/api/shares` // ../../app/api/shares/route.ts
    | `/api/status` // ../../app/api/status/route.ts
    | `/devices` // ../../app/devices/page.tsx
  type DynamicRoutes<T extends string = string> = 
    | `/api/files/${SafeSlug<T>}` // ../../app/api/files/[id]/route.ts
    | `/api/objects/${SafeSlug<T>}` // ../../app/api/objects/[id]/route.ts
    | `/api/public/${SafeSlug<T>}/file` // ../../app/api/public/[token]/file/route.ts
    | `/api/public/${SafeSlug<T>}/unlock` // ../../app/api/public/[token]/unlock/route.ts
    | `/api/shares/${SafeSlug<T>}` // ../../app/api/shares/[id]/route.ts
    | `/o/${SafeSlug<T>}` // ../../app/o/[id]/page.tsx
    | `/s/${SafeSlug<T>}` // ../../app/s/[token]/page.tsx
